...
$.pushnewzh = true; //是否忽略关键词推送知乎最新内容
$.splitpushbd = false; //是否分开推送百度榜单
$.pushnewbd = true; //是否忽略关键词推送百度最新内容
$.splitpushbl = true; //是否分开推送B站榜单
$.pushnewbl = true; //是否忽略关键词推送B站最新内容
$.splitpushdb = false; //是否分开推送豆瓣榜单
$.pushnewdb = true; //是否忽略关键词推送豆瓣最新内容
$.splitpushdy = false; //是否分开推送抖音榜单
$.pushnewdy = true; //是否忽略关键词推送抖音最新内容
$.splitpushk36 = false; //是否分开推送36氪榜单
$.pushnewk36 = true; //是否忽略关键词推送36氪最新内容
$.splitpushamz = false; //是否分开推送Kindle图书榜单
$.pushnewamz = false; //是否忽略关键词推送Kindle图书最新内容
$.splitpushrss = false; //是否分开推送rss内容
$.pushnewrss = true; //是否忽略关键词推送rss最新内容
$.splitpushzmz = false; //是否分开推送人人影视内容
$.pushnewzmz = true; //是否忽略关键词推送人人影视最新内容
